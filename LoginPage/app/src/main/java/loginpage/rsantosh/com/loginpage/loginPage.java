        ...
        if (editTextId.getText().toString().trim().isEmpty()) {
            ...
            if (editTextId.getText().toString().trim().matches(strEmailPattern)) {
                ...
                if(editTextPassword.getText().toString().trim().isEmpty()){
                    ...
                    Toast.makeText(this, "Enter a valid password format with lenght between 6 - 20 and with one upper case alphabet, one lower case alphabet, one  number and on special character.", Toast.LENGTH_LONG).show();

                    //Comparing the password with the pattern.
                }else if(editTextPassword.getText().toString().trim().matches(strPassword)){

                    //This message is displayed when the password pattern matches.
                    Toast.makeText(this,"Password format is right.",Toast.LENGTH_SHORT).show();
